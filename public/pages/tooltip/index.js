    ...
    render () {
        return (
            <div className='m-b-lg m-l m-r'>
                <h1>
                    提示信息层 - toolTip
                    <a href="mactt://message/user/03108" style={{border: 'none'}} className="m-l-lg btn-info-custom btn">
                ...
                <div>
                    ...
                    <Tooltip placement='bottomLeft' tooltip={this.state.text}>
                        <button className='btn btn-default m-r-xxl m-t-xxl m-l-xxl'>下左</button>
                    </Tooltip>
                    <Tooltip placement='bottom' tooltip={this.state.text}>
                        <button className='btn btn-default m-r-xxl m-l-xxl m-t-xxl'>下面</button>
                    </Tooltip>
                    <Tooltip placement='bottomRight' tooltip={this.state.text}>
                        <button className='btn btn-default m-l-xxl m-t-xxl'>下右</button>
                    </Tooltip>
                </div>
