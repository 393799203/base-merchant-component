...
class SelectTrigger extends Component {
    ...
    renderTree (keys, halfCheckedKeys, newTreeNodes, multiple) {
        ...
        if (props.treeCheckable) {
            ...
            if (props.inputValue) {
                ...
                trProps.treeNodesStates = props.treeNodesStates;
            }
        ...
        if (this.expandedKeys && this.expandedKeys.length) {
            trProps.expandedKeys = this.expandedKeys;
        }
        if (this.state.fireOnExpand) {
            trProps.expandedKeys = this.state.expandedKeys;
    ...
    render () {
        ...
        // const s = Date.now();
        let treeNodes;
        if (props.cachetreeData && this.treeNodes) {
