        ...
        switch (this.props.type) {
            case 'radio':
                return this.props.options.map(function (option, index) {
                    return (
                        <label className="xd-option" key={index}>
                            <input className="xd-radio"
                                type="radio"
                                value={option.value}
            ...
            case 'textarea':
                return (
                    <textarea className="xd-textarea"
            ...
            default:
                return (
                    <input className="xd-input" type={this.props.type} disabled={this.props.disabled}
                        placeholder={this.props.placeholder}
                        value={this.state.value}
                        {...eventHandlers}
                        onChange={this.handleChange} />
    ...
    render: function () {
        ...
        return (
            <div className={classNames.join(' ')}>
                {props.label ? <label className={props.required ? 'xd-label required' : 'xd-label'}>{props.label}</label> : null}
                <div className="xd-field">
                    {this.renderChild()}
                </div>
                <div className="xd-form-tip">{state.errorText}</div>
            </div>
        );
    }
});
