  ...
  // }
    ...
    renderChildren (props) {
        ...
        ((Array.isArray(children) &&
            children.every((item) => { return item.type && item.type.isTreeNode; })) ||
    ...
    render () {
        ...
        const selectHandle = () => {
            ...
            if (!props.disabled) {
                if ((props.selected || !props.dropTrigger) && this.state.dragNodeHighlight) {
            ...
            return (
                <a ref={(ref) => { this.selectHandle = ref; }} title={typeof content === 'string' ? content : ''} {...domProps}>
                    {icon}{title}
                </a>
            );
        };
