...
class Tree extends React.Component {
    ...
    onDrop (e, treeNode) {
        ...
        if ('expandedKeys' in this.props) {
            res.rawExpandedKeys = [...this.$rawExpandedKeys] || [...this.state.expandedKeys];
        }
    ...
    onCheck (treeNode) {
        ...
        if (this.props.checkStrictly) {
            ...
            this.$checkedKeys = checkedKeys = checkKeys.checkedKeys;
            if (!('checkedKeys' in this.props)) {
                this.setState({
                    checkedKeys
                });
    ...
    getRawExpandedKeys () {
        if (!this.$rawExpandedKeys && ('expandedKeys' in this.props)) {
            this.$rawExpandedKeys = [...this.state.expandedKeys];
        }
    }
    ...
    renderTreeNode (child, index, level = 0) {
        ...
        if ({}.hasOwnProperty.call(child.props, 'selectable')) {
    ...
    render () {
        ...
        if (props.checkable && (this.checkedKeysChange || props.loadData)) {
            if (props.checkStrictly) {
                ...
                let checkKeys;
                if (!props.loadData && this.checkKeys && this.$checkedKeys &&
                arraysEqual(this.$checkedKeys, checkedKeys)) {
        ...
        return (
            <ul {...domProps} unselectable ref={(ref) => { this.treeNodes = ref; }}>
